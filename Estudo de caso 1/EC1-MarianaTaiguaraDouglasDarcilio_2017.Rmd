...
```{r echo= FALSE}
cat("Estimativa de M�dia �:",med_est_val)
cat("Intervalo de Confian�a 95% �:",inter_conf_val)
cat("Desvio padr�o do estimador �:",desvio_pad_val)
```
